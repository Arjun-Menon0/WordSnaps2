...
public class Celebrities extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        card.setImageResource(celebs[gnum]);
    ...
    protected void correct(View v)
    {
        ...
        taboo.correct();
        Intent correctIntent = new Intent(this, Celebrities.class);
    ...
    protected void skip(View v)
    {
        taboo.setMillis(secPassed);
        taboo.skip();
        Intent skipIntent = new Intent(this, Celebrities.class);
